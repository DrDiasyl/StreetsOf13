...
/datum/crewmonitor
	...
	var/list/jobs = list(
		...
		// 40-49: Engineering
		JOB_FOREMAN = 40,
		JOB_CONSTRUCTION_WORKER = 41,
		JOB_FIREFIGHTER = 42,
		// 50-59: Cargo
		JOB_LOGISTIC_MANAGER = 50,
		JOB_LOGISTIC_TECHNICIAN = 51,
		// 60+: Service
		JOB_CHIEF_OF_INTERNAL_AFFAIRS = 60,
		JOB_BARTENDER = 61,
		JOB_CHEF = 62,
		JOB_COOK = 63,
		JOB_FARMER = 64,
		...
		JOB_PRIEST = 66,
		JOB_MIME = 67,
		JOB_STREET_CLEANER = 68,
		JOB_LAWYER = 69,
		JOB_PSYCHOLOGIST = 70,
		// 200-229: Centcom
		JOB_CENTCOM_ADMIRAL = 200,
		JOB_CENTCOM = 201,
		JOB_CENTCOM_OFFICIAL = 202,
		JOB_CENTCOM_COMMANDER = 203,
		JOB_CENTCOM_BARTENDER = 204,
		JOB_CENTCOM_CUSTODIAN = 205,
		JOB_CENTCOM_MEDICAL_DOCTOR = 206,
		JOB_CENTCOM_RESEARCH_OFFICER = 207,
		JOB_ERT_COMMANDER = 208,
		JOB_ERT_OFFICER = 209,
		JOB_ERT_ENGINEER = 210,
		JOB_ERT_MEDICAL_DOCTOR = 211,
		JOB_ERT_CLOWN = 212,
		JOB_ERT_CHAPLAIN = 213,
		JOB_ERT_JANITOR = 214,
		JOB_ERT_DEATHSQUAD = 215,
